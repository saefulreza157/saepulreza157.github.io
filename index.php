                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home </a>
                    <ul class="nav child_menu">
                      <li><a href="index1.php">Dosen</a></li>
                    </ul>
                    <ul class="nav child_menu">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            <td class=" ">5200411157</td>
                            <td class=" ">Saepul Reza Alparizi</td>
                            <td class=" ">Brebes</td>
                            <td class=" ">23 Mei 2003</td>
                            <td class=" ">Teknik Informatika</td>
                            <td class="a-right a-right ">C</td>
                            <td class=" last"><a href="#">Selengkapnya-></a>
                            </td>
                          </tr>
                          <tr class="even pointer">
                            <td class=" ">5200411183</td>
                            <td class=" ">Hadi Wiyono</td>
                            <td class=" ">Pacitan</td>
                            <td class=" ">20 Oktober 2001</td>
                            <td class=" ">Teknik Informatika</td>
                            <td class="a-right a-right ">C</td>
                            <td class=" last"><a href="#">Selengkapnya-></a>
                            </td>
                            <tr class="even pointer">
                            <td class=" ">5200411194</td>
                            <td class=" ">Muhammad Urfan Aji</td>
                            <td class=" ">Cirebon</td>
                            <td class=" ">2 Desember 2001</td>
                            <td class=" ">Teknik Informatika</td>
                            <td class="a-right a-right ">C</td>
                            <td class=" last"><a href="#">Selengkapnya-></a>
                            </td>
                            <tr class="even pointer">
                            <td class=" ">5200411460</td>
                            <td class=" ">Muhammad Khamdan Evada</td>
                            <td class=" ">Jakarta</td>
                            <td class=" ">12 Mei 2002</td>
                            <td class=" ">Teknik Informatika</td>
                            <td class="a-right a-right ">C</td>
                            <td class=" last"><a href="#">Selengkapnya-></a>
                            </td>
